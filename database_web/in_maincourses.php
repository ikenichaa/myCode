...
<!--FOOD-->
    ...
    <div class="box">
    	<div class="hvrbox hvrboxMainCourse">
    ...
    <tr>
      <td>
				<form action="in_maincourses.php" method="POST">
					...
					<?php
							...
							<button class="button button4" type="Submit" name="hi1" value="<?php echo $row['ProductID']?>"> Buy Here </button>
						<?php
					}
					?>
				</form>
